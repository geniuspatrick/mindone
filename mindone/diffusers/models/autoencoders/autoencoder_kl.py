...
class AutoencoderKL(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        self.quant_conv = nn.Conv2d(2 * latent_channels, 2 * latent_channels, 1, has_bias=True) if use_quant_conv else None
        self.post_quant_conv = nn.Conv2d(latent_channels, latent_channels, 1, has_bias=True) if use_post_quant_conv else None
